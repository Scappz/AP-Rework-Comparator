...
if __name__ == '__main__':
    ...
    if partidas_analizadas < 9000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\EUW.json'), 'euw', TABLE_BEFORE)
    if partidas_analizadas < 19000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\EUW.json'), 'euw', TABLE_AFTER)
    if partidas_analizadas < 28000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\NA.json'), 'na', TABLE_BEFORE)
    if partidas_analizadas < 38000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\NA.json'), 'na', TABLE_AFTER)
    if partidas_analizadas < 47000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\EUNE.json'), 'eune', TABLE_BEFORE)
    if partidas_analizadas < 57000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\EUNE.json'), 'eune', TABLE_AFTER)
    if partidas_analizadas < 66000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\LAN.json'), 'lan', TABLE_BEFORE)
    if partidas_analizadas < 76000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\LAN.json'), 'lan', TABLE_AFTER)
    if partidas_analizadas < 85000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\OCE.json'), 'oce', TABLE_BEFORE)
    if partidas_analizadas < 95000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\OCE.json'), 'oce', TABLE_AFTER)
    if partidas_analizadas < 104000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\KR.json'), 'kr', TABLE_BEFORE)
    if partidas_analizadas < 114000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\KR.json'), 'kr', TABLE_AFTER)
    if partidas_analizadas < 123000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\BR.json'), 'br', TABLE_BEFORE)
    if partidas_analizadas < 133000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\BR.json'), 'br', TABLE_AFTER)
    if partidas_analizadas < 142000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\RU.json'), 'ru', TABLE_BEFORE)
    if partidas_analizadas < 152000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\RU.json'), 'ru', TABLE_AFTER)
    if partidas_analizadas < 161000:
        fillDB(lista_partidas(r'..\matches_ids\5.11\RANKED_SOLO\LAS.json'), 'las', TABLE_BEFORE)
    if partidas_analizadas < 171000:
        fillDB(lista_partidas(r'..\matches_ids\5.14\RANKED_SOLO\LAS.json'), 'las', TABLE_AFTER)
